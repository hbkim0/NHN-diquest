"""mlp_data_service URL Configuration
...
urlpatterns = [
    ...
    path('api/v1/', include('bundles.urls')),
    path('api/v1/', include('annotations.urls')),
    path('api/v1/', include('versioned_datasets.urls')),
    path('api/v1/', include('labels.urls')),
    path('api/v1/', include('functions.urls')),
    path('api/v1/', include('experiments.urls')),
    path('api/v1/', include('models.urls')),
    path('api/v1/', include('tensorboards.urls')),
