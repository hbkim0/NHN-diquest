...
//datepicker
	...
	// if ($(".basicDate_full").length) {
	// 	$(".basicDate_full").flatpickr({
	// 			enableTime: false,
	// 			dateFormat: "Y-m-d",
	// 			locale: "ko",
	// 			animate:false,
	...
	// 			onOpen: [
	// 				function(){
	// 					$('.flatpickr-calendar').addClass('fullsize');
	// 				}
	// 			],
	// 			onClose: [
	// 				function(){
	// 					$('.flatpickr-calendar').removeClass('fullsize');
	// 				}
	// 			]
	// 	});
	// };
	...
	// if ($(".rangeDate_full").length) {
	// 	$(".rangeDate_full").flatpickr({
	// 			mode: 'range',
	// 			dateFormat: "Y-m-d",
	// 			locale: "ko",
	// 			animate:false,
...
//피드백 : 스마일	
	$.fn.feedback_smile=function() {
		if($(this).hasClass('on')){
			...
			$(this).closest('ul').find('.btn_likehate').removeClass('on');
			$(this).addClass('on');			
		};
	};
...
//모달 열기
	$('.btn_bot_modal').click(function(){
		...
		// if($('#'+modal_id).hasClass('type_carousel')){

		// 	//모달 캐로셀 실행
		// 	$('#'+modal_id).find('.owl-carousel').owlCarousel({
		// 		loop:false,
		// 		autoWidth:false,
		// 		margin:3,
		// 		nav:false,
		...
		$('.chat_area').addClass('overflow_hidden');
	});
...
//모달 닫기 및 초기화
	$('.btn_modal_close').click(function(){
		...
		//도움말 캐로셀 제거
		$(this).closest('.chat_modal').find('.owl-carousel').owlCarousel('destroy');
		$('.chat_area').removeClass('overflow_hidden');
	});
